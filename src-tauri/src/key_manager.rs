...
pub fn inject_private_key_to_cfg(app_cfg_mut: &mut AppCfg, address_opt: Option<AccountAddress>) -> anyhow::Result<(), CarpeError> {
  // gets the default profile
  let profile = app_cfg_mut.get_profile_mut(address_opt)?;
  ...
  // NOTE: intentionally not saving profile to disk
  Ok(())
}
